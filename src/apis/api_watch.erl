    ...
    case MsgType of
        ...
        <<"6">> ->
            ...
            try
                ...
                ResData = eadm_pgpool:equery(pool_pg, "replace into lc_watchhb(ptime, heartbeat)
        ...
        <<"8">> ->
            ...
            try
                ...
                ResData = eadm_pgpool:equery(pool_pg, "replace into lc_watchbp(ptime, diastolic, shrink)
