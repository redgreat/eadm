...
create_tables() ->
    %% 创建租户表
    create_table(eadm_tenant, record_info(fields, eadm_tenant),
                 [{disc_copies, [node()]},
    ...
    %% 创建用户表
    create_table(eadm_user, record_info(fields, eadm_user),
                 [{disc_copies, [node()]},
    ...
    %% 创建角色表
    create_table(eadm_role, record_info(fields, eadm_role),
                 [{disc_copies, [node()]},
    ...
    %% 创建用户角色关联表
    create_table(eadm_userrole, record_info(fields, eadm_userrole),
                 [{disc_copies, [node()]},
    ...
    %% 创建定时任务表
    create_table(eadm_crontab, record_info(fields, eadm_crontab),
                 [{disc_copies, [node()]},
    ...
    %% 创建仪表盘表
    create_table(eadm_dashboard, record_info(fields, eadm_dashboard),
                 [{disc_copies, [node()]},
    ...
    %% 创建设备表
    create_table(eadm_device, record_info(fields, eadm_device),
                 [{disc_copies, [node()]},
    ...
    %% 创建用户设备关联表
    create_table(eadm_userdevice, record_info(fields, eadm_userdevice),
                 [{disc_copies, [node()]},
...
%% @end
get_all_tables() ->
    [eadm_tenant, eadm_user, eadm_role, eadm_userrole,
     eadm_crontab, eadm_dashboard, eadm_device, eadm_userdevice].
